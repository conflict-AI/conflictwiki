...
We introduce the ConflictWiki dataset, a large collection of [Wikipedia articles on militarized conflict](https://en.wikipedia.org/wiki/Category:Conflicts).
...
Find a table listing all hyperparameter settings here

[hyperparameter settings](hyperparams.md) 
