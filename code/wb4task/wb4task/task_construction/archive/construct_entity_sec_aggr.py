...
from wb4task.task_construction.ally_enemy_pairs import ally_enemy_pairs
...
if __name__ == "__main__":
    ...
    gt = ally_enemy_pairs(config, c_e_id, c_id = [15802807])

    X_E, X_F, sec_sec_E, ent_ent_E, sec_sec_F, ent_ent_F = preconstruct_entity_sec_task(gt, e_id_sec_embed, entity_dict)
